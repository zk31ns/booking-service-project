...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('average_bill', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('is_smoking_area', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('has_power_outlet', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('has_window', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('active', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.PrimaryKeyConstraint('id'),
